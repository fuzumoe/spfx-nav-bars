...
import * as strings from 'ReactBootstrapNavBarApplicationCustomizerStrings';

const LOG_SOURCE: string = 'ReactBootstrapNavBarApplicationCustomizer';
 ...
 */
export interface IReactBootstrapNavBarApplicationCustomizerProperties {
  // This is an example; replace with your own property
  testMessage: string;
}

/** A Custom Action which can be run during execution of a Client Side Application */
export default class ReactBootstrapNavBarApplicationCustomizer
  extends BaseApplicationCustomizer<IReactBootstrapNavBarApplicationCustomizerProperties> {
