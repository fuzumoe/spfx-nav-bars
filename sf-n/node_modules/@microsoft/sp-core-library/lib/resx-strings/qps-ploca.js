define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "isNullValidateError": "***Ţĥē väĺūě ƒŏř \"{0}\" mŭşť ŉőţ ƀę ņűļĺ",
      "isUndefinedValidateError": "***Ŧħę vȁľųē ƒőř \"{0}\" můśŧ ƞŏţ Ƃȅ ŭŉďēƒĭƞĕď",
      ...
      "serviceScopeConsumingBeforeFinished": "***Ċȁŉŉơŧ čơņśűmē ŝėŕvĭĉĕş ƀěćàűšě ţĥē ŝċơƿȇ īŝ ŋŏť ƒĩńīşĥĕď ŷěţ",
      ...
      "serviceScopeProvideServiceAfterFinishedError": "***Čȁŋŉőţ ŗȅġįśţęř šěŕvıċȅ Ƃęĉäŭśȇ ŧĥě şċőƿȅ įş åŀŕȇăđƴ ƒĩƞĩšĥėđ",
