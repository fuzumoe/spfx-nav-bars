...
var ColorSlider = /** @class */ (function (_super) {
    ...
    ColorSlider.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: 'root', className: css('ms-ColorPicker-slider', styles.slider, className, isAdjusting && 'is-adjusting'), onMouseDown: this._onMouseDown },
