...
import { BaseComponent, css, findIndex, findScrollableParent, getParent, divProperties, getNativeProps, autobind } from '../../Utilities';
var RESIZE_DELAY = 16;
...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({ ref: 'root' }, divProps, { role: (role === undefined) ? 'list' : role, className: css('ms-List', className) }),
            React.createElement("div", { ref: 'surface', className: css('ms-List-surface'), role: 'presentation' }, pageElements)));
    };
    ...
    List.prototype._onRenderPage = function (pageProps, defaultRender) {
        ...
        var cells = (items || []).map(function (item, offset) {
            ...
            return (React.createElement("div", { role: cellRole, className: css('ms-List-cell'), key: itemKey, "data-list-index": index, "data-automationid": 'ListCell' }, onRenderCell && onRenderCell(item, index)));
        });
