...
var CommandBarPage = /** @class */ (function (_super) {
    ...
    CommandBarPage.prototype.render = function () {
        ...
        return (React.createElement(ComponentPage, { title: 'CommandBar', componentName: 'CommandBarExample', exampleCards: React.createElement("div", null,
                ...
                React.createElement(ExampleCard, { title: 'CommandBar with customized renderred items', code: CommandBarCustomizationExampleCode },
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Display more than 2-3 items on the right side of the bar (or left side in left to right experiences)."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, CommandBarStatus)) }));
    };
