...
var BreadcrumbPage = /** @class */ (function (_super) {
    ...
    BreadcrumbPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Breadcrumb', componentName: 'BreadcrumbExample', exampleCards: React.createElement("div", null,
                ...
                React.createElement("p", null, "Breadcrumbs are typically placed, in horizontal form, under the masthead or navigation of an experience, above the primary content area.")), bestPractices: React.createElement("div", null), dos: React.createElement("div", null,
                ...
                React.createElement("ul", null,
                    React.createElement("li", null, "Don't use Breadcrumbs as a primary way to navigate an app or site."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, BreadcrumbStatus)) }));
    };
