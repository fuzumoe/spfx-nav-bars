...
var TogglePage = /** @class */ (function (_super) {
    ...
    TogglePage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Toggle', componentName: 'ToggleExample', exampleCards: React.createElement(ExampleCard, { title: 'Default Toggles', code: ToggleBasicExampleCode },
                React.createElement(ToggleBasicExample, null)), propertiesTables: React.createElement(PropertiesTableSet, { sources: [
                ...
                React.createElement("h2", { className: FontClassNames.xLarge }, "Choosing between Toggle and Checkbox"),
                ...
                React.createElement("ul", null, "Don\u2019t use a Toggle if the user will have to do something else or go somewhere else in order to experience its effect. If any extra step is required for changes to be effective, you should use a checkbox and corresponding \"Apply\" button instead of a Toggle.")), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, ToggleStatus)) }));
    };
    return TogglePage;
}(React.Component));
export { TogglePage };
