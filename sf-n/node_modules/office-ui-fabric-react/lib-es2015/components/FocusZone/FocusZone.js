...
import { BaseComponent, EventGroup, autobind, css, divProperties, elementContains, getDocument, getId, getNextElement, getNativeProps, getParent, getPreviousElement, getRTL, isElementFocusZone, isElementFocusSubZone, isElementTabbable } from '../../Utilities';
...
var FocusZone = /** @class */ (function (_super) {
    ...
    FocusZone.prototype.componentDidMount = function () {
        ...
        if (this._root) {
            ...
            var parentElement = getParent(this._root, ALLOW_VIRTUAL_ELEMENTS);
            while (parentElement &&
    ...
    FocusZone.prototype.focus = function (forceIntoFirstElement) {
        ...
        if (this._root) {
            if (!forceIntoFirstElement && this._root.getAttribute(IS_FOCUSABLE_ATTRIBUTE) === 'true' && this._isInnerZone) {
                ...
                return this.focusElement(getNextElement(this._root, firstChild, true));
            }
        }
        return false;
    };
        ...
        if (isInnerZoneKeystroke &&
            ...
            switch (ev.which) {
                ...
                case 36 /* home */:
                    ...
                    var firstChild = this._root.firstChild;
                    if (this.focusElement(getNextElement(this._root, firstChild, true))) {
                        break;
                    }
                    return;
                case 35 /* end */:
                    ...
                    if (this.focusElement(getPreviousElement(this._root, lastChild, true, true, true))) {
                        break;
                    }
                    return;
                case 13 /* enter */:
    ...
    FocusZone.prototype._moveFocus = function (isForward, getDistanceFromCenter, ev) {
        ...
        do {
            element = (isForward ?
                ...
                getPreviousElement(this._root, element));
            if (isBidirectional) {
                if (element) {
        ...
        if (candidateElement && candidateElement !== this._activeElement) {
            ...
            if (isForward) {
                return this.focusElement(getNextElement(this._root, this._root.firstElementChild, true));
            }
            else {
                return this.focusElement(getPreviousElement(this._root, this._root.lastElementChild, true, true, true));
            }
        }
        return changedFocus;
    };
