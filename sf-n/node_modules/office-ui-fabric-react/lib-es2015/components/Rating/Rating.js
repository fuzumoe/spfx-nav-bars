...
import { RatingSize } from './Rating.Props';
...
var Rating = /** @class */ (function (_super) {
    ...
    Rating.prototype.render = function () {
        ...
        return (React.createElement("div", { className: css('ms-Rating', this.props.className, (_a = {},
                _a['ms-Rating--large ' + styles.rootIsLarge] = this.props.size === RatingSize.Large,
                _a)), role: 'application' },
            React.createElement("div", { className: css('ms-Rating-container', styles.container), role: 'radiogroup', "aria-labelledby": this.props.ariaLabelId }, stars)));
        var _a;
    };
    Rating.prototype._renderStar = function (rating) {
        var inputId = this._id + "-" + rating;
        return (React.createElement("div", { className: css('ms-Rating-star', styles.star, (_a = {},
                ...
                _a)), key: rating },
            React.createElement("input", { className: css('ms-Rating-input', styles.input), type: 'radio', name: this._id, id: inputId, value: rating, "aria-labelledby": this._labelId + "-" + rating, disabled: this.props.disabled, checked: rating === this.state.rating, onChange: this._onChange.bind(this, rating), onFocus: this._onFocus.bind(this, rating), onBlur: this._onBlur.bind(this, rating) }),
            React.createElement("label", { className: css('ms-Rating-label', styles.label), htmlFor: inputId },
    ...
    Rating.prototype._getLabel = function (rating) {
        ...
        return (React.createElement("span", { id: this._labelId + "-" + rating, className: css('ms-Rating-labelText', styles.labelText) }, rating + " " + text));
    };
    Rating.prototype._getIcon = function () {
        return React.createElement(Icon, { iconName: this.props.icon || 'favoriteStarFill' });
    };
