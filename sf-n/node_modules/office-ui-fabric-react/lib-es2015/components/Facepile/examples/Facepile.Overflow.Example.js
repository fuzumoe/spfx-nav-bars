    ...
    FacepileOverflowExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-FacepileExample' },
            ...
            React.createElement("div", { className: 'control' },
                React.createElement(Slider, { label: 'Number of Personas:', min: 0, max: 6, step: 1, showValue: true, value: this.state.displayedPersonas, onChange: this._onChangePersonaNumber }),
