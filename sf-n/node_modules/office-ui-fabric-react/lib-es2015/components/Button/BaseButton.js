...
import { getClassNames } from './BaseButton.classNames';
...
var BaseButton = /** @class */ (function (_super) {
    ...
    BaseButton.prototype.render = function () {
        ...
        this._classNames = getClassNames(styles, className, variantClassName, iconProps && iconProps.className, menuIconProps && menuIconProps.className, isPrimaryButtonDisabled, checked, !!this.state.menuProps, this.props.split);
    ...
    BaseButton.prototype._onRenderIcon = function (buttonProps, defaultRender) {
        ...
        if (iconProps) {
            return Icon(tslib_1.__assign({}, iconProps, { className: this._classNames.icon }));
        }
        return null;
    };
    ...
    BaseButton.prototype._onRenderSplitButtonContent = function (tag, buttonProps) {
        ...
        var classNames = styles && getSplitButtonClassNames(styles, !!disabled, !!this.state.menuProps, !!checked);
