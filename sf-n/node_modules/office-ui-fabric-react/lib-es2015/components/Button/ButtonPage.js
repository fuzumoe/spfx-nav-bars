...
var ButtonPage = /** @class */ (function (_super) {
    ...
    ButtonPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Button', componentName: 'ButtonExample', exampleCards: React.createElement("div", null,
                ...
                React.createElement(ExampleCard, { title: 'Custom Split Button', code: ButtonSplitExampleCode },
                    React.createElement(ButtonSplitCustomExample, { disabled: this.state.areButtonsDisabled, checked: this.state.areButtonsChecked }))), propertiesTables: React.createElement("div", null,
                ...
                React.createElement("p", null,
                    ...
                    React.createElement(Link, { href: '#/examples/icon' }, "IIconProps"),
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Don't put anything other than text in a button."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, ButtonStatus)) }));
    };
