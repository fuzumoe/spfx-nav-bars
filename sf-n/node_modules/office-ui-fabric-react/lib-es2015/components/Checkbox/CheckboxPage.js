...
var CheckboxPage = /** @class */ (function (_super) {
    ...
    CheckboxPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Checkbox', componentName: 'CheckboxExample', exampleCards: React.createElement("div", null,
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Don't put two groups of Checkboxes next to each other. Separate the two groups with labels."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, CheckboxStatus)) }));
    };
    return CheckboxPage;
}(React.Component));
export { CheckboxPage };
