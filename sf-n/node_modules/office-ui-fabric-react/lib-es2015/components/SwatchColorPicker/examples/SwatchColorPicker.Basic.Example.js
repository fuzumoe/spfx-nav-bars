...
var SwatchColorPickerBasicExample = /** @class */ (function (_super) {
    ...
    SwatchColorPickerBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(SwatchColorPicker, { columnCount: 4, cellShape: 'circle', colorCells: [
            ...
            React.createElement(SwatchColorPicker, { columnCount: 4, cellShape: 'square', colorCells: [
                    { id: 'a', label: 'green', color: '#00ff00' },
                    { id: 'b', label: 'orange', color: '#ffa500' },
                    { id: 'c', label: 'blue', color: '#0000ff' },
                    { id: 'd', label: 'red', color: '#ff0000' }
            ...
            React.createElement(SwatchColorPicker, { disabled: true, columnCount: 4, cellShape: 'circle', colorCells: [
                    { id: 'a', label: 'green', color: '#00ff00' },
                    { id: 'b', label: 'orange', color: '#ffa500' },
                    { id: 'c', label: 'blue', color: '#0000ff' },
                    { id: 'd', label: 'red', color: '#ff0000' }
