...
var ProgressIndicatorPage = /** @class */ (function (_super) {
    ...
    ProgressIndicatorPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'ProgressIndicator', componentName: 'ProgressIndicatorExample', exampleCards: React.createElement(ExampleCard, { title: 'Default ProgressIndicator', code: ProgressIndicatorBasicExampleCode },
                React.createElement(ProgressIndicatorBasicExample, null)), propertiesTables: React.createElement(PropertiesTableSet, { sources: [
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Cause progress to \u201Crewind\u201D to show new steps"))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, ProgressIndicatorStatus)) }));
    };
