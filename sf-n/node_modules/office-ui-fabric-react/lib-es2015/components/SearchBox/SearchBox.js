...
var SearchBox = /** @class */ (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({ ref: this._resolveRef('_rootElement'), className: css('ms-SearchBox', className, styles.root, (_c = {},
            ...
            React.createElement("div", { className: css('ms-SearchBox-iconContainer', styles.iconContainer) },
                React.createElement(Icon, { className: css('ms-SearchBox-icon', styles.icon), iconName: 'Search' })),
            React.createElement("input", { id: id, className: css('ms-SearchBox-field', styles.field), placeholder: labelText, onChange: this._onInputChange, onInput: this._onInputChange, onKeyDown: this._onKeyDown, value: value, disabled: this.props.disabled, "aria-label": this.props.ariaLabel ? this.props.ariaLabel : this.props.labelText, ref: this._resolveRef('_inputElement') }),
            React.createElement("div", { className: css('ms-SearchBox-clearButton', styles.clearButton), onClick: this._onClear },
                React.createElement(Icon, { iconName: 'Clear' }))));
        var _c;
    };
    /**
