...
var SearchBoxPage = /** @class */ (function (_super) {
    ...
    SearchBoxPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'SearchBox', componentName: 'SearchBoxExample', exampleCards: React.createElement("div", null,
                ...
                React.createElement("h2", { className: FontClassNames.xLarge }, "Zero input state "),
                ...
                React.createElement("h2", { className: FontClassNames.xLarge }, "Autocomplete suggestions"),
                ...
                React.createElement("h2", { className: FontClassNames.xLarge }, "Full search"),
                ...
                React.createElement("h2", { className: FontClassNames.xLarge }, "Search scopes"),
                ...
                React.createElement("h2", { className: FontClassNames.xLarge }, "SearchBox with no parent container"),
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Use the Underlined SearchBox for CommandBars."))), donts: React.createElement("div", null,
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Don't use SearchBox if you cannot reliably provide accurate results."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, SearchBoxStatus)) }));
    };
