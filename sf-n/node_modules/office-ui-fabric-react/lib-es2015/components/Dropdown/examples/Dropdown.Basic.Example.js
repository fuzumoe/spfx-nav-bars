...
var DropdownBasicExample = /** @class */ (function (_super) {
    ...
    DropdownBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'DropdownBasicExample' },
            React.createElement(Dropdown, { className: 'Dropdown-example', placeHolder: 'Select an Option', label: 'Basic uncontrolled example:', id: 'Basicdrop1', ariaLabel: 'Basic dropdown example', options: [
            ...
            React.createElement(Dropdown, { className: 'Dropdown-example', label: 'Disabled uncontrolled example with defaultSelectedKey:', defaultSelectedKey: 'D', options: [
                    { key: 'A', text: 'Option a' },
                    { key: 'B', text: 'Option b' },
                    { key: 'C', text: 'Option c' },
                    { key: 'D', text: 'Option d' },
            ...
            React.createElement(Dropdown, { className: 'Dropdown-example', label: 'Controlled example:', selectedKey: selectedItem && selectedItem.key, onChanged: this.changeState, onFocus: this._log('onFocus called'), onBlur: this._log('onBlur called'), placeHolder: 'Select an Option', options: [
                    { key: 'A', text: 'Option a' },
                    { key: 'B', text: 'Option b' },
                    { key: 'C', text: 'Option c' },
                    { key: 'D', text: 'Option d' },
            ...
            React.createElement(Dropdown, { placeHolder: 'Select options', label: 'Multi-Select uncontrolled example:', defaultSelectedKeys: ['Apple', 'Banana'], onFocus: this._log('onFocus called'), onBlur: this._log('onBlur called'), multiSelect: true, options: [
