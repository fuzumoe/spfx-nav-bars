...
var DropdownCustomExample = /** @class */ (function (_super) {
    ...
    DropdownCustomExample.prototype.render = function () {
        return (React.createElement("div", { className: 'dropdownExample' },
            React.createElement(Dropdown, { placeHolder: 'Select an Option', label: 'Custom example:', id: 'Customdrop1', ariaLabel: 'Custom dropdown example', onRenderPlaceHolder: this._onRenderPlaceHolder, onRenderTitle: this._onRenderOption, onRenderOption: this._onRenderOption, onRenderCaretDown: this._onRenderCaretDown, options: [
