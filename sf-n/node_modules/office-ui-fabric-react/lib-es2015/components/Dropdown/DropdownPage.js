...
var DropdownPage = /** @class */ (function (_super) {
    ...
    DropdownPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Dropdown', componentName: 'DropdownExample', exampleCards: React.createElement("div", null,
                ...
                React.createElement(ExampleCard, { title: 'Customized Dropdown', code: DropdownCustomExampleCode },
                    React.createElement(DropdownCustomExample, null))), propertiesTables: React.createElement(PropertiesTableSet, { sources: [
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Use a Dropdown when the selected option is more important than the alternatives (in contrast to radio buttons where all the choices are visible putting more emphasis on the other options)."))), donts: React.createElement("div", null), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, DropdownStatus)) }));
    };
    return DropdownPage;
}(React.Component));
export { DropdownPage };
