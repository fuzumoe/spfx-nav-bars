...
var LabelPage = /** @class */ (function (_super) {
    ...
    LabelPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Label', componentName: 'LabelExample', exampleCards: React.createElement(ExampleCard, { title: 'Label', code: LabelBasicExampleCode },
                React.createElement(LabelBasicExample, null)), propertiesTables: React.createElement(PropertiesTableSet, { sources: [
                ...
                React.createElement("ul", null,
                    ...
                    React.createElement("li", null, "Don\u2019t use full sentences or complex punctuation (colons, semicolons, etc.)."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, LabelStatus)) }));
    };
    return LabelPage;
}(React.Component));
export { LabelPage };
