...
import { autobind, BaseComponent, css, getNativeProps, imageProperties } from '../../Utilities';
import { ImageFit, ImageLoadState, ImageCoverStyle } from './Image.Props';
import { AnimationClassNames } from '../../Styling';
import * as stylesImport from './Image.scss';
var styles = stylesImport;
export var CoverStyleMap = (_a = {},
    _a[ImageCoverStyle.landscape] = 'ms-Image-image--landscape ' + styles.imageIsLandscape,
    _a[ImageCoverStyle.portrait] = 'ms-Image-image--portrait ' + styles.imageIsPortrait,
    _a);
export var ImageFitMap = (_b = {},
    _b[ImageFit.center] = 'ms-Image-image--center ' + styles.imageIsCenter,
    _b[ImageFit.contain] = 'ms-Image-image--contain ' + styles.imageIsContain,
    _b[ImageFit.cover] = 'ms-Image-image--cover ' + styles.imageIsCover,
    _b[ImageFit.none] = 'ms-Image-image--none ' + styles.imageIsNone,
    _b);
...
var Image = /** @class */ (function (_super) {
    ...
    Image.prototype.render = function () {
        ...
        var loaded = loadState === ImageLoadState.loaded || (loadState === ImageLoadState.notLoaded && this.props.shouldStartVisible);
        // If image dimensions aren't specified, the natural size of the image is used.
        return (React.createElement("div", { className: css('ms-Image', styles.root, className, (_b = {},
            ...
            React.createElement("img", tslib_1.__assign({}, imageProps, { onLoad: this._onImageLoaded, onError: this._onImageError, key: KEY_PREFIX + this.props.src || '', className: css('ms-Image-image', styles.image, CoverStyleMap[coverStyle], (imageFit !== undefined) && ImageFitMap[imageFit], !loaded && 'is-notLoaded', loaded && 'is-loaded ' + styles.imageIsLoaded, shouldFadeIn && 'is-fadeIn', loadState === ImageLoadState.error && 'is-error', loaded && shouldFadeIn && !shouldStartVisible && AnimationClassNames.fadeIn400, (_c = {},
