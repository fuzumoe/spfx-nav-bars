...
import { assign, BaseComponent, css, getId, getNativeProps, inputProperties } from '../../Utilities';
...
var ChoiceGroup = /** @class */ (function (_super) {
                ...
                options.map(function (option) {
                    ...
                    return (React.createElement("div", { key: option.key, className: css('ms-ChoiceField', styles.choiceField, (_c = {},
                        ...
                        React.createElement("div", { className: css('ms-ChoiceField-wrapper', styles.choiceFieldWrapper) },
                            React.createElement("input", tslib_1.__assign({ ref: _this._resolveRef('_inputElement'), id: option.id, className: css('ms-ChoiceField-input', styles.input), type: 'radio', name: _this.props.name || _this._id, disabled: option.disabled || _this.props.disabled, checked: option.key === keyChecked, required: required, onChange: _this._onChange.bind(_this, option), onFocus: _this._onFocus.bind(_this, option), onBlur: _this._onBlur.bind(_this, option), "aria-labelledby": option.id }, getNativeProps(option, inputProperties))),
    ...
    ChoiceGroup.prototype._onRenderField = function (option) {
        ...
        return (React.createElement("label", { htmlFor: option.id, className: css('ms-ChoiceField-field', styles.field, (_a = {},
                ...
                _a)) },
            option.imageSrc && (React.createElement("div", { className: css('ms-ChoiceField-innerField', styles.innerField) },
                React.createElement("div", { className: css('ms-ChoiceField-imageWrapper', styles.imageWrapper, (_b = {},
                        ...
                        _b)) },
                    React.createElement(Image, { src: option.imageSrc, width: option.imageSize ? option.imageSize.width : undefined, height: option.imageSize ? option.imageSize.height : undefined })),
                React.createElement("div", { className: css('ms-ChoiceField-imageWrapper', styles.imageWrapper, (_c = {},
                        ...
                        _c)) },
                    React.createElement(Image, { src: option.selectedImageSrc, width: option.imageSize ? option.imageSize.width : undefined, height: option.imageSize ? option.imageSize.height : undefined })))),
            option.iconProps
            ...
            option.imageSrc || option.iconProps
                ? (React.createElement("div", { className: css('ms-ChoiceField-labelWrapper', styles.labelWrapper) }, onRenderLabel(option))) : onRenderLabel(option)));
        var _a, _b, _c;
    };
