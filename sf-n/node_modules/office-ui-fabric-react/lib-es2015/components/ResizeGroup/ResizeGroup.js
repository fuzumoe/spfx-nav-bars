...
import { css, BaseComponent } from '../../Utilities';
...
var ResizeGroup = /** @class */ (function (_super) {
    ...
    ResizeGroup.prototype.render = function () {
        ...
        return (React.createElement("div", { className: css('ms-ResizeGroup'), ref: this._resolveRef('_root') },
            this._nextResizeGroupStateProvider.shouldRenderDataToMeasureInHiddenDiv(dataToMeasure) && (React.createElement("div", { className: css(styles.measured), ref: this._resolveRef('_measured') }, onRenderData(dataToMeasure))),
