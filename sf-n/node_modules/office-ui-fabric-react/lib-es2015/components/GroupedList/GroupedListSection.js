...
var GroupedListSection = /** @class */ (function (_super) {
    ...
    GroupedListSection.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: 'root', className: css('ms-GroupedList-group', styles.group, this._getDroppingClassName()), role: 'presentation' },
            onRenderGroupHeader(groupHeaderProps, this._onRenderGroupHeader),
            group && group.isCollapsed ?
                null :
                (hasNestedGroups ?
                    (React.createElement(List, { ref: 'list', items: group.children, onRenderCell: this._renderSubGroup, getItemCountForPage: this._returnOne })) :
    ...
    GroupedListSection.prototype._onRenderGroup = function (renderCount) {
        ...
        return (React.createElement(List, tslib_1.__assign({ items: items, onRenderCell: this._onRenderGroupCell(onRenderCell, groupNestingDepth), ref: 'list', renderCount: Math.min(count, renderCount), startIndex: startIndex }, listProps)));
    };
