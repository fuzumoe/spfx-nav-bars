...
import { BaseComponent, autobind, assign, css } from '../../Utilities';
...
var GroupedList = /** @class */ (function (_super) {
    ...
    GroupedList.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: 'root', className: css('ms-GroupedList', styles.root, className), "data-automationid": 'GroupedList', "data-is-scrollable": 'false', role: 'presentation' }, !groups ?
            this._renderGroup(null, 0) : (React.createElement(List, { ref: 'list', items: groups, onRenderCell: this._renderGroup, getItemCountForPage: this._returnOne, usePageCache: usePageCache, onShouldVirtualize: onShouldVirtualize }))));
    };
