...
import { BaseComponent, autobind, getNativeProps, inputProperties } from '../../../Utilities';
...
var BaseAutoFill = /** @class */ (function (_super) {
    ...
    BaseAutoFill.prototype.render = function () {
        ...
        return (React.createElement("input", tslib_1.__assign({}, nativeProps, { ref: this._resolveRef('_inputElement'), value: displayValue, autoCapitalize: 'off', autoComplete: 'off', onChange: this._onChange, onKeyDown: this._onKeyDown, onClick: this.props.onClick ? this.props.onClick : this._onClick, "data-lpignore": true })));
    };
    ...
    tslib_1.__decorate([
        autobind
    ], BaseAutoFill.prototype, "_updateValue", null);
    return BaseAutoFill;
}(BaseComponent));
export { BaseAutoFill };
