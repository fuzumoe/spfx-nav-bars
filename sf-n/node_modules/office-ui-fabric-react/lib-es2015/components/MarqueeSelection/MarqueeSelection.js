...
import { AutoScroll, BaseComponent, autobind, css, findScrollableParent, getDistanceBetweenPoints, getRTL } from '../../Utilities';
...
var MarqueeSelection = /** @class */ (function (_super) {
    ...
    MarqueeSelection.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({}, rootProps, { className: css('ms-MarqueeSelection', styles.root, rootProps && rootProps.className), ref: 'root' }),
            children,
