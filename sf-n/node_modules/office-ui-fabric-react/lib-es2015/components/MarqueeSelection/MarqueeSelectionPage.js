...
var MarqueeSelectionPage = /** @class */ (function (_super) {
    ...
    MarqueeSelectionPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'MarqueeSelection', componentName: 'MarqueeSelectionExample', exampleCards: React.createElement(ExampleCard, { title: 'Basic Selection Example', code: MarqueeSelectionBasicExampleCode },
                React.createElement(MarqueeSelectionBasicExample, null)), overview: React.createElement("div", null,
