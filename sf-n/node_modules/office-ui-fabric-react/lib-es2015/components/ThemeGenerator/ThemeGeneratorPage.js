...
import { getContrastRatio, updateA, isDark, getColorFromString } from 'office-ui-fabric-react/lib/utilities/color/index';
...
var ThemeGeneratorPage = /** @class */ (function (_super) {
    ...
    ThemeGeneratorPage.prototype._cognitiveVisionCallback = function (e) {
        ...
        if (xhr.status === 200) {
            ...
            var bgColorIsDark = isDark(getColorFromString(bgColor));
            ThemeGenerator.setSlot(themeRules[BaseSlots[BaseSlots.backgroundColor]], bgColor, bgColorIsDark, true, true);
            ThemeGenerator.setSlot(themeRules[BaseSlots[BaseSlots.primaryColor]], '#' + response.color.accentColor, bgColorIsDark, true, true);
            ThemeGenerator.setSlot(themeRules[BaseSlots[BaseSlots.foregroundColor]], getHexFromColor(response.color.dominantColorForeground, false), bgColorIsDark, true, true);
    ...
    ThemeGeneratorPage.prototype._makeNewTheme = function () {
        var themeAsJson = ThemeGenerator.getThemeAsJson(this.state.themeRules);
    ...
    ThemeGeneratorPage.prototype._baseColorSlotPicker = function (baseSlot, title) {
        ...
        return (React.createElement("div", { className: 'ms-themer-paletteSlot', key: baseSlot },
            ...
            React.createElement("div", null,
                React.createElement(ColorPicker, { key: 'baseslotcolorpicker' + baseSlot, color: this.state.themeRules[BaseSlots[baseSlot]].color.str, 
                    /* tslint:disable:jsx-no-bind */
                    onColorChanged: _onColorChanged.bind(this) })),
            React.createElement("div", { className: 'ms-themer-swatchBg', style: { backgroundColor: this.state.themeRules[BaseSlots[baseSlot]].color.str } },
                React.createElement("div", { className: 'ms-themer-swatch', style: { backgroundColor: this.state.themeRules[BaseSlots[baseSlot]].color.str } }),
