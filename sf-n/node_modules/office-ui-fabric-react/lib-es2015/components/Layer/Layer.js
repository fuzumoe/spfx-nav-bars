    ...
    Layer.prototype.componentDidUpdate = function () {
        ...
        if (host) {
            ...
            if (!this._layerElement) {
                var doc = getDocument(this._rootElement);
                this._layerElement = doc.createElement('div');
                this._layerElement.className = css('ms-Layer', (_a = {},
            ...
            ReactDOM.unstable_renderSubtreeIntoContainer(this, (React.createElement(Fabric, { className: css('ms-Layer-content', styles.content) }, this.props.children)), this._layerElement, function () {
