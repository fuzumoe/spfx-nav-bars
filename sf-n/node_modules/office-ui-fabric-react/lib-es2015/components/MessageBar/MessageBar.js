...
var MessageBar = /** @class */ (function (_super) {
    ...
    function MessageBar(props) {
        ...
        _this.ICON_MAP = (_a = {},
            ...
            _a[MessageBarType.blocked] = 'Blocked',
    ...
    MessageBar.prototype._getDismissDiv = function () {
        if (this.props.onDismiss) {
            return (React.createElement(IconButton, { disabled: false, className: css('ms-MessageBar-dismissal', styles.dismissal), onClick: this.props.onDismiss, iconProps: { iconName: 'Cancel' }, ariaLabel: this.props.dismissButtonAriaLabel }));
        }
        return null;
    };
    MessageBar.prototype._getDismissOneLine = function () {
        if (this.props.onDismiss) {
            return (React.createElement("div", { className: css('ms-MessageBar-dismissOneline', styles.dismissOneline) }, this._getDismissDiv()));
        }
        return null;
    };
    ...
    MessageBar.prototype._renderMultiLine = function () {
        return (React.createElement("div", { className: css(this._getClassName(), 'ms-MessageBar-multiline', styles.multiline, this.props.onDismiss && styles.dismissalMultiline, this.props.actions && styles.actionableMultiline), role: 'status', "aria-live": this._getAnnouncementPriority() },
    ...
    MessageBar.prototype._renderSingleLine = function () {
        return (React.createElement("div", { className: css(this._getClassName(), 'ms-MessageBar-singleline', styles.singleline, this.props.onDismiss && 'ms-MessageBar-dismissalOneline ' + styles.rootIsOneline, this.props.actions && styles.actionableOneline) },
            React.createElement("div", { className: css(styles.content, 'ms-MessageBar-content') },
                this._getIconSpan(),
                this._renderInnerText(),
    ...
    MessageBar.prototype._renderInnerText = function () {
        return (React.createElement("div", { className: css('ms-MessageBar-text', styles.text), id: this.state.labelId },
