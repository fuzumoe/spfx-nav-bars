...
import { BaseComponent, autobind, elementContains, getNativeProps, divProperties, getFirstFocusable, getLastTabbable, getNextElement } from '../../Utilities';
var FocusTrapZone = /** @class */ (function (_super) {
    ...
    FocusTrapZone.prototype.focus = function () {
        ...
        if (focusSelector) {
            ...
            _firstFocusableChild = getNextElement(root, root.firstChild, true, false, false, true);
        }
    ...
    FocusTrapZone.prototype._onKeyboardHandler = function (ev) {
        ...
        var root = this.refs.root;
        var _firstFocusableChild = getFirstFocusable(root, root.firstChild, true);
        var _lastFocusableChild = getLastTabbable(root, root.lastChild, true);
