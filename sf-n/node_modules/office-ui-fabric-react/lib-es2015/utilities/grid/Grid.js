...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.render = function () {
        ...
        return (this.props.doNotContainWithinFocusZone ? content : (React.createElement(FocusZone, { isCircularNavigation: this.props.shouldFocusCircularNavigate, className: this.props.containerClassName, onBlur: this.props.onBlur }, content)));
    };
    return Grid;
}(BaseComponent));
export { Grid };
