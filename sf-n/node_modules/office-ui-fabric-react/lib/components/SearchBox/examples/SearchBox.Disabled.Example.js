...
var SearchBoxDisabledExample = /** @class */ (function (_super) {
    ...
    SearchBoxDisabledExample.prototype.render = function () {
        return (React.createElement("div", { className: 'ms-SearchBoxExample' },
            React.createElement(SearchBox_1.SearchBox, { onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); }, disabled: true }),
            React.createElement(SearchBox_1.SearchBox, { onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); }, underlined: true, disabled: true })));
    };
