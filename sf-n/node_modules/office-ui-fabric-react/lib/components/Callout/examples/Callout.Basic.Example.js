...
var CalloutBasicExample = /** @class */ (function (_super) {
    ...
    CalloutBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-CalloutExample' },
            ...
            isCalloutVisible && (React.createElement(Callout_1.Callout, { className: 'ms-CalloutExample-callout', ariaLabelledBy: 'callout-label-1', ariaDescribedBy: 'callout-description-1', role: 'alertdialog', gapSpace: 0, target: this._menuButtonElement, onDismiss: this._onCalloutDismiss, setInitialFocus: true },
