define(["require", "exports", "tslib", "react", "./ComponentStatus.Props", "./ComponentStatus.scss"], function (require, exports, tslib_1, React, ComponentStatus_Props_1) {
    "use strict";
    ...
    var ComponentStatus = /** @class */ (function (_super) {
        ...
        ComponentStatus.prototype._colorForComponentStateStatus = function (testCoverageStatus) {
            switch (testCoverageStatus) {
                case ComponentStatus_Props_1.ChecklistStatus.unknown:
                    return 'lightgrey';
                case ComponentStatus_Props_1.ChecklistStatus.fail:
                case ComponentStatus_Props_1.ChecklistStatus.none:
                    return 'red';
                case ComponentStatus_Props_1.ChecklistStatus.poor:
                    return 'yellow';
                case ComponentStatus_Props_1.ChecklistStatus.fair:
                    return 'yellowgreen';
                case ComponentStatus_Props_1.ChecklistStatus.pass:
                case ComponentStatus_Props_1.ChecklistStatus.good:
                    return 'brightgreen';
            }
            return 'red';
        };
        ComponentStatus.defaultProps = {
            keyboardAccessibilitySupport: ComponentStatus_Props_1.ChecklistStatus.fail,
            markupSupport: ComponentStatus_Props_1.ChecklistStatus.fail,
            highContrastSupport: ComponentStatus_Props_1.ChecklistStatus.fail,
            rtlSupport: ComponentStatus_Props_1.ChecklistStatus.fail,
            testCoverage: ComponentStatus_Props_1.ChecklistStatus.none
        };
