        ...
        DetailsListPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'DetailsList', componentName: 'DetailsListExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Make columns so narrow that it truncates the information in typical cases."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, DetailsList_checklist_1.DetailsListStatus)) }));
        };
