define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/ProgressIndicator.Basic.Example", "../../demo/ComponentStatus/ComponentStatus", "./ProgressIndicator.checklist"], function (require, exports, tslib_1, React, example_app_base_1, ProgressIndicator_Basic_Example_1, ComponentStatus_1, ProgressIndicator_checklist_1) {
    "use strict";
    ...
    var ProgressIndicatorPage = /** @class */ (function (_super) {
        ...
        ProgressIndicatorPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'ProgressIndicator', componentName: 'ProgressIndicatorExample', exampleCards: React.createElement(example_app_base_1.ExampleCard, { title: 'Default ProgressIndicator', code: ProgressIndicatorBasicExampleCode },
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Cause progress to \u201Crewind\u201D to show new steps"))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, ProgressIndicator_checklist_1.ProgressIndicatorStatus)) }));
        };
