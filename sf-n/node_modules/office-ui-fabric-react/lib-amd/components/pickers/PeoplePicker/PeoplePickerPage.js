define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "@uifabric/example-app-base", "./examples/PeoplePicker.Types.Example", "../../../demo/ComponentStatus/ComponentStatus", "./PeoplePicker.checklist"], function (require, exports, tslib_1, React, Link_1, example_app_base_1, PeoplePicker_Types_Example_1, ComponentStatus_1, PeoplePicker_checklist_1) {
    "use strict";
        ...
        PeoplePickerPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'PeoplePicker', componentName: 'PeoplePickerExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Use the PeoplePicker without sufficient space"))), componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, PeoplePicker_checklist_1.PeoplePickerStatus)) }));
        };
