define(["require", "exports", "../../utilities/color/shades", "../../utilities/color/colors", "../../Utilities"], function (require, exports, shades_1, colors_1, Utilities_1) {
    ...
    function themeRulesStandardCreator() {
        ...
        slotRules[BaseSlots[BaseSlots.primaryColor]].color = colors_1.getColorFromString('#0078d7');
        ...
        _makeFabricSlotRule(FabricSlots[FabricSlots.neutralSecondary], BaseSlots.foregroundColor, shades_1.Shade.Shade5);
        _makeFabricSlotRule(FabricSlots[FabricSlots.neutralPrimaryAlt], BaseSlots.foregroundColor, shades_1.Shade.Shade6);
