define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/SearchBox.FullSize.Example", "./examples/SearchBox.Underlined.Example", "./examples/SearchBox.Disabled.Example", "./examples/SearchBox.Small.Example", "../../Styling", "../../demo/ComponentStatus/ComponentStatus", "./SearchBox.checklist"], function (require, exports, tslib_1, React, example_app_base_1, SearchBox_FullSize_Example_1, SearchBox_Underlined_Example_1, SearchBox_Disabled_Example_1, SearchBox_Small_Example_1, Styling_1, ComponentStatus_1, SearchBox_checklist_1) {
    "use strict";
        ...
        SearchBoxPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'SearchBox', componentName: 'SearchBoxExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don't use SearchBox if you cannot reliably provide accurate results."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, SearchBox_checklist_1.SearchBoxStatus)) }));
        };
