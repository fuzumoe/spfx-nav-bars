define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Checkbox", "office-ui-fabric-react/lib/Dropdown", "office-ui-fabric-react/lib/Facepile", "office-ui-fabric-react/lib/Persona", "office-ui-fabric-react/lib/Slider", "office-ui-fabric-react/lib/Utilities", "./FacepileExampleData", "../../../common/_exampleStyles.scss", "./Facepile.Examples.scss"], function (require, exports, tslib_1, React, Checkbox_1, Dropdown_1, Facepile_1, Persona_1, Slider_1, Utilities_1, FacepileExampleData_1, exampleStylesImport) {
    "use strict";
    ...
    var FacepileBasicExample = /** @class */ (function (_super) {
        ...
        FacepileBasicExample.prototype._onChangeFadeIn = function (ev, checked) {
            this.setState(function (prevState) {
                prevState.imagesFadeIn = checked;
                return prevState;
            });
        };
        FacepileBasicExample.prototype._onChangePersonaNumber = function (value) {
            this.setState(function (prevState) {
                prevState.numberOfFaces = value;
                return prevState;
            });
        };
        FacepileBasicExample.prototype._onChangePersonaSize = function (value) {
            this.setState(function (prevState) {
        ...
        ], FacepileBasicExample.prototype, "_onChangeFadeIn", null);
        tslib_1.__decorate([
            Utilities_1.autobind
        ], FacepileBasicExample.prototype, "_onChangePersonaNumber", null);
        tslib_1.__decorate([
            Utilities_1.autobind
        ], FacepileBasicExample.prototype, "_onChangePersonaSize", null);
