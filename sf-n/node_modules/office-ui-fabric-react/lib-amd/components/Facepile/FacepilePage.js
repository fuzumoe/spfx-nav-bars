define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/Facepile.AddFace.Example", "./examples/Facepile.Basic.Example", "./examples/Facepile.Overflow.Example", "../../Styling", "../../demo/ComponentStatus/ComponentStatus", "./Facepile.checklist"], function (require, exports, tslib_1, React, example_app_base_1, Facepile_AddFace_Example_1, Facepile_Basic_Example_1, Facepile_Overflow_Example_1, Styling_1, ComponentStatus_1, Facepile_checklist_1) {
    "use strict";
        ...
        FacepilePage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Facepile', componentName: 'FacepileExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        ...
                        React.createElement("li", null, "Don\u2019t use this control for experiences where you need to manage details of hundreds of users, you are better off using a list control."))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, Facepile_checklist_1.FacepileStatus)) }));
        };
        return FacepilePage;
    }(React.Component));
