define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/Toggle.Basic.Example", "../../Styling", "../../demo/ComponentStatus/ComponentStatus", "./Toggle.checklist"], function (require, exports, tslib_1, React, example_app_base_1, Toggle_Basic_Example_1, Styling_1, ComponentStatus_1, Toggle_checklist_1) {
    "use strict";
    ...
    var TogglePage = /** @class */ (function (_super) {
        ...
        TogglePage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Toggle', componentName: 'ToggleExample', exampleCards: React.createElement(example_app_base_1.ExampleCard, { title: 'Default Toggles', code: ToggleBasicExampleCode },
