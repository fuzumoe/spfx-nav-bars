define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/Persona", "office-ui-fabric-react/lib/Icon", "../../../common/TestImages", "../../../common/_exampleStyles.scss", "./PersonaExample.scss"], function (require, exports, tslib_1, React, Utilities_1, Persona_1, Icon_1, TestImages_1, exampleStylesImport) {
    "use strict";
    ...
    var PersonaCustomRenderExample = /** @class */ (function (_super) {
        ...
        PersonaCustomRenderExample.prototype.render = function () {
            return (React.createElement("div", { className: 'ms-PersonaExample' },
                ...
                React.createElement("div", { className: exampleStyles.exampleLabel }, "Custom coin size = 150"),
                React.createElement(Persona_1.Persona, tslib_1.__assign({}, examplePersona, { coinSize: 150, presence: Persona_1.PersonaPresence.online, onRenderSecondaryText: this._onRenderSecondaryText }))));
        };
