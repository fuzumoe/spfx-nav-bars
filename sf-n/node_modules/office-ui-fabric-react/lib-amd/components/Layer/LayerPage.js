    ...
    var LayerPage = /** @class */ (function (_super) {
        ...
        LayerPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'Layer', componentName: 'LayerExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement("ul", null,
                        React.createElement("li", null, 'Don\'t use string refs ( ref=\'root\' ).'))), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, Layer_checklist_1.LayerStatus)) }));
        };
        return LayerPage;
    }(React.Component));
