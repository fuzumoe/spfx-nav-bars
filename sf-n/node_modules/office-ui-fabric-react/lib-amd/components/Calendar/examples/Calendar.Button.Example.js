        ...
        CalendarButtonExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                this.state.showCalendar && (React.createElement(Callout_1.Callout, { isBeakVisible: false, className: 'ms-DatePicker-callout', gapSpace: 0, doNotLayer: false, target: this._calendarButtonElement, directionalHint: 4 /* bottomLeftEdge */, onDismiss: this._onDismiss, setInitialFocus: false },
                    React.createElement(Calendar_1.Calendar, { onSelectDate: this._onSelectDate, onDismiss: this._onDismiss, isMonthPickerVisible: true, value: this.state.selectedDate, firstDayOfWeek: Calendar_1.DayOfWeek.Sunday, strings: DayPickerStrings, isDayPickerVisible: this.props.isDayPickerVisible, highlightCurrentMonth: this.props.highlightCurrentMonth })))));
        };
