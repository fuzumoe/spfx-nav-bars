define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/Layer", "@uifabric/example-app-base", "./examples/TeachingBubble.Basic.Example", "./examples/TeachingBubble.Condensed.Example", "./examples/TeachingBubble.Illustration.Example", "../../demo/ComponentStatus/ComponentStatus", "./TeachingBubble.checklist"], function (require, exports, tslib_1, React, Link_1, Layer_1, example_app_base_1, TeachingBubble_Basic_Example_1, TeachingBubble_Condensed_Example_1, TeachingBubble_Illustration_Example_1, ComponentStatus_1, TeachingBubble_checklist_1) {
    "use strict";
    ...
    var TeachingBubblePage = /** @class */ (function (_super) {
        ...
        TeachingBubblePage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'TeachingBubble', componentName: 'TeachingBubbleExample', exampleCards: React.createElement(Layer_1.LayerHost, null,
                    ...
                    React.createElement("span", null, " allow the user to display important hints on their web pages with a callout box.")), componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, TeachingBubble_checklist_1.TeachingBubbleStatus)) }));
        };
